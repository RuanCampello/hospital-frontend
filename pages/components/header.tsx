  ...
  return (
    <div className='bg-slate-700 text-slate-100 text-lg px-12 py-3 flex justify-between items-center'>
      ...
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-slate-600 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="px-1 py-1 ">
              <ButtonComponent name='View Hospitals' view='getHospitalView'/>
              <ButtonComponent name='Add Hospital' view='addHospitalView'/>
              <ButtonComponent name='Delete Hospital' view='delHospitalView' color={'text-red-500'}/>
            </div>
          </Menu.Items>
        </Transition>
      </Menu>
